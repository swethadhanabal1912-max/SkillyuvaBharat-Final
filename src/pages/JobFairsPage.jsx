...
//       <style>{`
//         @import url('https://fonts.googleapis.com/css2?family=Raleway:wght@400;600;700;800;900&family=Crimson+Pro:ital,wght@0,300;1,400;1,600&family=IBM+Plex+Mono:wght@500&display=swap');

//         .jfp-container { max-width: 1100px; margin: 0 auto; padding: 0 24px; }

//         /* HERO */
//         .jfp-hero { background: #F4D8BE; padding: 130px 0 110px; text-align: center; position: relative; overflow: hidden; }
...
//         .jfp-hero h1 em { color: #E8650A; font-style: italic; font-family: 'Crimson Pro', serif; font-weight: 600; }
...
//         .jfp-section-title em { font-family: 'Crimson Pro', serif; font-style: italic; color: #E8650A; font-weight: 600; }
...
//         .jfp-drawer-item { background: #FBF0E1; border-radius: 10px; padding: 13px 14px; }
...
const QUICK_STATS = [
  { icon: <Ticket size={20} />, value: "1,248+", label: "Fairs conducted", accent: "#E8650A" },
  { icon: <MapPin size={20} />, value: "6", label: "States & UTs covered", accent: "#1A7A2E" },
  { icon: <Briefcase size={20} />, value: "100+", label: "Companies onboarded", accent: "#111" },
  { icon: <Users size={20} />, value: "2.5 L+", label: "Youth placed in interviews", accent: "#E8650A" },
];
